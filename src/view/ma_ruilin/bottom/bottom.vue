        ...
        <div class="block" style="background:#1C1C1C">
          ...
          <div style="width:100%;height:79%;overflow-y: auto">
            <div class="awitInfo" v-for="(item,index) in btnData4" :key="index">
              <p style="width:100%;height:.4rem;line-height:.4rem;font-size:.2rem;color:#F4F4F4;text-align:center">{{item.name}}</p>
              <div class="time">
                <p>待ち人数： <b style="font-size:.25rem;color:#FFFFFF">{{item.awitNum}}</b></p>
                <p>待ち時間： <b style="font-size:.25rem;color:#FFFFFF">{{item.awitTime}}</b> </p>
              </div>
            </div>
          </div>
